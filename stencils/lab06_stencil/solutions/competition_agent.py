...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Auction Competition Agent for Lab 06')
    parser.add_argument('--name', type=str, help='Agent name (default: AuctionCompetition_<random>)')

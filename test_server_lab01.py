#!/usr/bin/env python3
"""
Test script to connect the lab01 example solution to the server
"""
...
async def main():
    """Test the lab01 example solution with the server."""
    
    print("Testing Lab01 Example Solution with AGT Server")
    print("=" * 50)
